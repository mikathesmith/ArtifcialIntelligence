# Create an MLP network that will process the 3-class MNIST set.
# Try to create an architecture that will lead to best generalisation.
# Make decisions about the learning - the cost, learning parameter and how long to train for.
# Compare your results with someone else in the lab - how good is your model?
# What are the differences in the architecture?
